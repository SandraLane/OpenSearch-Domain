...
host = 'https://vpc-project-domain-bk5pxzludxa3kxlrslizb24joe.us-east-1.es.amazonaws.com/_dashboards' # the OpenSearch Service domain, e.g. https://search-mydomain.us-west-1.es.amazonaws.com
index = 'mygoogle'
datatype = '_doc'
